...
public class AnimatedSprite extends Sprite {
    ...
    public AnimatedSprite(Component c, Graphics2D g2d) {
        super(c, g2d);
        animImage = new ImageEntity(c);
        currFrame = 0;
        totFrames = 0;
        animDir = 1;
        frCount = 0;
    ...
    public AnimatedSprite(CaninoGameEngine2D e) {
        super(e.getComponent(), e.getScreen());
        animImage = new ImageEntity(e.getComponent());
        currFrame = 0;
        totFrames = 0;
        animDir = 1;
        frCount = 0;
